...
## These estimates of PMI are non-symmetric
If we want PMI of two words in a sentence,
$$\mathrm{PMI}(w_1;w_2\mid c) = \log \frac{p(w_1\mid w_2, c)}{p(w_1 \mid c)}, \text{where $c$ is the rest of the sentence} $$
